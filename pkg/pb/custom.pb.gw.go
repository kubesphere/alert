...
func request_AlertManagerCustom_ModifyPolicyByAlert_0(ctx context.Context, marshaler runtime.Marshaler, client AlertManagerCustomClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ModifyPolicyByAlertRequest
	...
	msg, err := client.ModifyPolicyByAlert(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func request_AlertManagerCustom_ModifyAlertByName_0(ctx context.Context, marshaler runtime.Marshaler, client AlertManagerCustomClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ModifyAlertByNameRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ModifyAlertByName(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func request_AlertManagerCustom_DeleteAlertsByName_0(ctx context.Context, marshaler runtime.Marshaler, client AlertManagerCustomClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteAlertsByNameRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.DeleteAlertsByName(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
...
func RegisterAlertManagerCustomHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AlertManagerCustomClient) error {
	...
	mux.Handle("PATCH", pattern_AlertManagerCustom_ModifyPolicyByAlert_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AlertManagerCustom_ModifyPolicyByAlert_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_AlertManagerCustom_ModifyPolicyByAlert_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("PATCH", pattern_AlertManagerCustom_ModifyAlertByName_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_AlertManagerCustom_ModifyAlertByName_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_AlertManagerCustom_ModifyAlertByName_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("DELETE", pattern_AlertManagerCustom_DeleteAlertsByName_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_AlertManagerCustom_DeleteAlertsByName_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_AlertManagerCustom_DeleteAlertsByName_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_AlertManagerCustom_ModifyPolicyByAlert_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "policybyalert"}, ""))

	pattern_AlertManagerCustom_ModifyAlertByName_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "alert"}, ""))

	pattern_AlertManagerCustom_DeleteAlertsByName_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "alert"}, ""))
...
var (
	forward_AlertManagerCustom_ModifyPolicyByAlert_0 = runtime.ForwardResponseMessage

	forward_AlertManagerCustom_ModifyAlertByName_0 = runtime.ForwardResponseMessage

	forward_AlertManagerCustom_DeleteAlertsByName_0 = runtime.ForwardResponseMessage
